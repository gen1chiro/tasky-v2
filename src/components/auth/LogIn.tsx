    ...
    return (
        <>
            {isUserLoggedIn && navigate(from, {replace: true})}
                <main
                    className='w-full h-screen flex items-center justify-center bg-white bg-[radial-gradient(100%_150%_at_50%_50%,rgba(0,163,255,0.13)_0,rgba(0,163,255,0)_50%,rgba(0,163,255,0)_100%)]'>
                    <div
